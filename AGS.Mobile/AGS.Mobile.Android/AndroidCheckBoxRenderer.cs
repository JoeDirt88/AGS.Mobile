...
namespace AGS.Mobile.Droid
{
    ...
    public class CheckboxRenderer : ViewRenderer<Checkbox, AppCompatCheckBox>, CompoundButton.IOnCheckedChangeListener
    {
        ...
        {
            ((Xamarin.Forms.IViewController)Element).SetValueFromRenderer(Checkbox.IsCheckedProperty, isChecked);
        ...
        public override Xamarin.Forms.SizeRequest GetDesiredSize(int widthConstraint, int heightConstraint)
        {
            ...
            if (sizeConstraint.Request.Width == 0)
            {
                ...
                sizeConstraint = new Xamarin.Forms.SizeRequest(new Xamarin.Forms.Size(width, (int)sizeConstraint.Request.Height),
